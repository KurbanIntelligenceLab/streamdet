...
The positive control for the streaming paper: the known WACV numbers
(mv_27k_C1_lbfgs_phase2b_logo: mean OOD 0.815 over 7 generators, RvR 0.643;
leaderboard matched-27k row 0.832 with t2vz) must reproduce before any
streaming result is trusted. Uses vidaudit.audit.protocol.run_logo/run_rvr
