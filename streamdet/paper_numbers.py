...
print("=" * 70)
codec = cell_auc("results/stream-scores/sh_0000.csv", "codec matched")
pixel = cell_auc("results/pixel-scores/sh_0000.csv", "pixel matched")
aigvd = cell_auc("results/stream-scores-aigvd/sh_0000.csv", "AIGVDBench")
lf = cell_auc("results/stream-scores-longform/sh_0000.csv", "long-form")
print("=" * 70)
anytime_curve("results/stream-scores/sh_0000.csv", "codec")
anytime_curve("results/pixel-scores/sh_0000.csv", "pixel")
anytime_curve("results/stream-scores-longform/sh_0000.csv", "longform")
print("=" * 70)
cascade_fused("results/stream-scores/sh_0000.csv",
              "results/pixel-scores/sh_0000.csv", "codec->pixel")
