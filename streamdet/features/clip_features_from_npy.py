...
Validates our feature path end-to-end against the reference toolkit's table: for every clip
in the subset CSV, load npy_path and run vidaudit's feature_vector on the FULL
array (clip-level, exactly what the reference harness did). If our port is faithful,
